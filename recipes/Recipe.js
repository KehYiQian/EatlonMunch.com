...
document.querySelectorAll('a[href^="#"]').forEach((anchor) => {
    anchor.addEventListener('click', function (e) {
        e.preventDefault(); //prevent the anchor action to prevent it jumpt to the section directly
        document.querySelector(this.getAttribute('href')).scrollIntoView({
            behavior: 'smooth' //action for smoothly scrolling
        });
    });
});
...
var popUpElements = document.querySelectorAll('span, img');
